      ...
      <div className="bg-container">
        <nav className="nav-container">
          ...
          <ul className="nav-container2">
            <li>
              <p className="score">
                Score: <spam>{score}</spam>
              </p>
            </li>
            <li className="timer-position">
              <img
                className="time-sec-logo"
                alt="timer"
                src="https://assets.ccbp.in/frontend/react-js/match-game-timer-img.png "
              />
              <p className="score2"> {time} sec</p>
            </li>
          </ul>
        </nav>
        <div>
          {!isTrue && (
            <div className="middle-container">
              <img className="image-large" src={imgUrl} alt="match" />
              ...
              <ul className="ul-image-container">
                {thumbnailList.map(eachObject => (
                  <li key={eachObject.id} className="li-image-container">
                    <button
                      type="button"
